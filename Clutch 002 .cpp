...
bool FuncionJuegoTerminado(int BarajaJugadores[10]);
...
int FuncionPrimerJugador(int BarajaJugadores[],int Mazo[]);
...
// Baraja.
    ...
    string MazoNombres[Cartas]= {"10 CORAZON","10 PICA","10 TREBOL","10 DIAMANTES",
                                 "J CORAZON","J PICA","J TREBOL","J DIAMANTES",
                                 "Q CORAZON","Q PICA","Q TREBOL","Q DIAMANTES",
                                 "K CORAZON","K PICA","K TREBOL","K DIAMANTES",
                                 "A CORAZON","A PICA","A TREBOL","A DIAMANTES",
                                };
    int CartaBloqueadas[2]={20,30};
    int UltimaCarta2;
    int UltimaCarta1;
...
// Mezclo mazo.
    ...
    do
    {
       ...
       /* bool PrimerVuelta2=false,PrimerVuelta;
                    do {
                    CartaRandom = rand()% 20;

                    bool PrimerVuelta = (Verificar(CartaRandom,Mazo));

                    while(PrimerVuelta==false)
          {
                          Mazo[19]=CartaRandom;
                          PrimerVuelta2=false;
          }

                    }while(PrimerVuelta==true);
                    ...
                    int AuxMazo[20];
                    AuxMazo[19]=Mazo[19];
                    Mazo[19]=Mazo[CartaRandom];
                    Mazo[CartaRandom]=AuxMazo[19];

                    //cout << Mazo[19]<< " "<< " - ";
        //Verficar baraja mezclada.
                for(int i=0; i<20; i++)
                {
                    ///// cout << MazoNombres[Mazo[i]] << " "<<endl<<endl;
                     ///cout  << i;
                }
                cout << endl<<endl;*/
...
// do while para que las cartas servidas
    ...
    if(FuncionPrimerJugador(BarajaJugadores,Mazo)==1)
    {
        PrimerTurno=Jugador1;;
        SegundoTurno=Jugador2;

    }
    else if (FuncionPrimerJugador(BarajaJugadores,Mazo)==2)
    {
...
// Muestro barajas comienzo de juego.
        ...
        if (PrimerTurno==Jugador2)
        {
            ...
            case 1:
                ...
                CartaElegida=CartaElegida+4;

                srand(time(NULL));
                Pick=((rand() % 9));
                AuxBaraJugadores[CartaElegida]=BarajaJugadores[CartaElegida];
                BarajaJugadores[CartaElegida]=MazoRestante[Pick];
                MazoRestante[Pick]=AuxBaraJugadores[CartaElegida];
            ...
            case 2:
                ...
                while((CartaElegida-1)==CartaBloqueadas[1]);
            ...
            case 3:
                ...
                do
                {
                    do
                    {
                        ...
                        case 1:
                            ...
                            {
                            case 0:
                                CartaElegidaContraria=1;
                                op2=0;
                                break;
                            case 1:
                                CartaElegidaContraria=2;
                                op2=0;
                                break;
                            case 2:
                                CartaElegidaContraria=3;
                                op2=0;
                                break;
                            case 3:
                                CartaElegidaContraria=4;
                                op2=0;
                                break;
                            case 4:
                                CartaElegidaContraria=5;
                                op2=0;
                                break;
                            default:
                                break;
                ...
                while((CartaElegidaContraria-1)==CartaBloqueadas[1]);
                ...
                CartaElegida=CartaElegida+4;
                CartaElegidaContraria=CartaElegidaContraria-1;

                AuxBaraJugadores[CartaElegida]=BarajaJugadores[CartaElegida];
                BarajaJugadores[CartaElegida]=BarajaJugadores[CartaElegidaContraria];
                BarajaJugadores[CartaElegidaContraria]=AuxBaraJugadores[CartaElegida];
            ...
            case 4:
                ...
                CartaElegida=CartaElegida+4;
                CartaElegidaContraria=CartaElegidaContraria+4;
                rlutil::setColor(rlutil::GREEN);
            ...
            case 5:
                ...
                cout << "     _____________________________________________________________________________________"<<endl<<endl;
                rlutil::locate(2,27);
                cout << "***Elige una carta de tu propia corral y bloqueala para que tu rival no pueda modificarla  (1-5)***"<<endl<<endl;
                rlutil::locate(40,29);
                rlutil::setColor(rlutil::YELLOW);
                cout<< "Tus cartas: "<<endl<<endl;
                ...
                CartaBloqueadas[0]=CartaElegida;
        ...
        int  CartasDesacomodadas1=0;
        int  CartasDesacomodadas2=0;
        ...
        case 1:
            ...
            if(BarajaJugadores[5]>3) {
               TotalPuntos1=TotalPuntos1+5;
            CartasDesacomodadas1++;
            }
            if(BarajaJugadores[6]<4||BarajaJugadores[6]>7) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas1++;
            }
            if(BarajaJugadores[7]<8||BarajaJugadores[6]>11) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas1++;
            }
            if(BarajaJugadores[8]<12||BarajaJugadores[6]>15) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas1++;
            }
            if(BarajaJugadores[9]<16) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas1++;
            }
            ...
            rlutil::setColor(rlutil::GREEN);
               // cout << "                  ____________________________________________________                       "<<endl<<endl;
                ...
                cout << "                  Puntos por partida ganada:            " << " +15 PDV                                    "<<endl;

                rlutil::locate(5, 43);

            if (TurnoVictoria==false)
            {
                cout << "                  Puntos por nunca pasar de turno:      " <<   " +10 PDV                                   "<<endl;
            }
            else {
                cout << "                  Puntos por nunca pasar de turno:      " <<   " +0 PDV                                 "<<endl;
            }
            rlutil::locate(5, 44);
            if (UltimaCarta1==1)
            {
                cout << "                  Puntos ganar robando la ultima carta: " <<   " +10 PDV                                    "<<endl;
            }
            else {

                cout << "                  Puntos ganar robando la ultima carta: " <<   " +0 PDV                                      "<<endl;
            }
            rlutil::locate(5, 45);
            if(RoboDeCarta2==false)
            {
                cout << "                  Puntos por no sufrir robos de cartas: " <<   " +5 PDV                                        "<<endl;
            }
            else {
                cout << "                  Puntos por no sufrir robos de cartas: " <<   " +0 PDV                                     "<<endl<<endl;
            }
            rlutil::locate(5, 46);
                cout << "                  Total puntos por cartas desacomodadas del rival: " << "+"<< CartasDesacomodadas1*5 << " PDV                                            ";
            rlutil::locate(5, 47);
            rlutil::setColor(rlutil::GREEN);
               cout << "                  ____________________________________________________                                                           "<<endl<<endl;

               rlutil::locate(5, 49);
            cout<< "                  Presiona cualquiera tecla para retornar al menu >";
            rlutil:: anykey();
        ...
        case 5:
            ...
            if(BarajaJugadores[0]>3) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas2++;
            }
            if(BarajaJugadores[1]<4||BarajaJugadores[6]>7) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas2++;
            }
            if(BarajaJugadores[2]<8||BarajaJugadores[6]>11) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas2++;
            }
            if(BarajaJugadores[3]<12||BarajaJugadores[6]>15) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas2++;
            }
            if(BarajaJugadores[4]<16) {
               TotalPuntos1=TotalPuntos1+5;
               CartasDesacomodadas2++;
            }
            ...
            rlutil::locate(5, 46);
                cout << "                  Total puntos por cartas desacomodadas del rival: " << "+"<< CartasDesacomodadas2*5 << " PDV                                            ";
            rlutil::locate(5, 47);
            rlutil::setColor(rlutil::GREEN);
               cout << "                  ____________________________________________________                                                           "<<endl<<endl;
...
void FuncionOpcionesDejuego(char Presionar)
{
    ...
    rlutil::setColor(rlutil::YELLOW);
    rlutil::locate(0,45);
    cout << "     5>Elige una carta de tu propia corral y bloqueala para que tu rival no pueda modificarla "<<endl;
    rlutil::setColor(rlutil::GREEN);
    rlutil::locate(0,46);
